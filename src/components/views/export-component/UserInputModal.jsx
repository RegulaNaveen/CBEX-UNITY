...
const UserInputModal = ({
  ...
  try {
    ...
    roles = roleList.includes(defaultOption)
      ? roleList
      : [...[defaultOption], ...roleList];
    milestoneOptionsWithDefault = milestoneOptions.includes(defaultOption)
      ? milestoneOptions
      : [...[defaultOption], ...milestoneOptions];
  } catch (error) {
    console.log(error);
  }
  ...
  const handleMileStoneChange = e => {
    ...
    if (
      ...
      newValue.includes(defaultOption) &&
      newValue.length != milestoneOptionsWithDefault.length
    ) {
      ...
      !milestones.includes(defaultOption) &&
      !newValue.includes(defaultOption) &&
      newValue.length == milestoneOptionsWithDefault.length - 1
    ) {
      newValue = milestoneOptionsWithDefault;
    } else if (
      milestones.includes(defaultOption) &&
