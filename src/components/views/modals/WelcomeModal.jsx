  ...
  return (
    ...
    >
      <section className="role-modal">
        <p className="para">
          Before you can use all the feature of the Unity platform, we need to
          setup the role for your profile.
        </p>
      </section>
      <section className="role-modal">
        <b>Please select your user role.</b>
        <p className="para">
          {' '}
          This role can always be changed in your profile.
        </p>
      </section>
      <section>
