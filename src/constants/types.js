...
const SSO_AUTH = {
  ...
  ERROR_ON_USER_ACKNOWLEDGE: 'error_on_user_acknowledge',
...
const PROPOSAL = {
  ...
  BOX_OPPORTUNITY_FOLDER_ID: 'BOX_OPPORTUNITY_FOLDER_ID',
  ...
  SET_ACTIVE_TABINDEX: 'SET_ACTIVE_TABINDEX',
  SET_V_TAB_ACTIVE_INDEX: 'SET_V_TAB_ACTIVE_INDEX',
  SET_V_TAB_USER_PREFERENCE: 'SET_V_TAB_USER_PREFERENCE',
  SET_UNITY_TAB_QUESTION_LOADING: 'SET_UNITY_TAB_QUESTION_LOADING',
  SET_PANEL_STATUS: 'SET_PANEL_STATUS',
  CHANGE_BID_STATUS_OPERATION: 'CHANGE_BID_STATUS_OPERATION',
  WIDGET_UPDATE: 'WIDGET_UPDATE',
  TOGGLE_FAVOURITE: 'PROPOSAL_FAVOURITE_TOGGLE',
  SET_CUSTOM_NAME: 'SET_CUSTOM_NAME',
  SET_NEXT_MILESTONE: 'set_next_milestone',
  TOGGLE_EDIT_CUSTOM_NAME_MODAL: 'TOGGLE_EDIT_CUSTOM_NAME_MODAL',
  SET_EDIT_OPP_INFO: 'SET_EDIT_OPP_INFO',
  CLEAR_EDIT_OPP_INFO: 'CLEAR_EDIT_OPP_INFO',
  DASHBOARD_PROPOSAL_DETAIL: 'DASHBOARD_PROPOSAL_DETAIL',
  UPDATE_PROPOSAL_DETAIL_SF: 'UPDATE_PROPOSAL_DETAIL_SF',
  UPDATE_DASHBOARD_OPPORTUNITY: 'UPDATE_DASHBOARD_OPPORTUNITY ',
  CHANGE_BID_LOADER: 'CHANGE_BID_LOADER'
};
...
const PROPOSALS = {
  ...
  SET_ASSIGNED_TAB_NUM_OF_ROWS: 'SET_ASSIGNED_TAB_NUM_OF_ROWS',
  DASHBOARD_PROPOSAL_DETAIL: 'DASHBOARD_PROPOSAL_DETAIL',
  UPDATE_DASHBOARD_BID: 'UPDATE_DASHBOARD_BID',
  UPDATE_DASHBOARD_OPPORTUNITY: 'UPDATE_DASHBOARD_OPPORTUNITY',
  UPDATE_PROPOSAL_DETAIL_SF: 'UPDATE_PROPOSAL_DETAIL_SF'
};
...
const UNITY_TABS = {
  FETCH_UNITY_TABS: 'FETCH_UNITY_TABS',
  SET_UNITY_TABS: 'SET_UNITY_TABS',
  DELETE_UNITY_TABS: 'DELETE_UNITY_TABS',
  DUPLICATE_UNITY_TABS: 'DUPLICATE_UNITY_TABS',
  SET_CAN_SEND_EMAIL_IN_UNITY_TABS: 'SET_CAN_SEND_EMAIL_IN_UNITY_TABS',
  UPDATE_FILTERS: 'UPDATE_FILTERS',
  RESET_FILTERS: 'RESET_FILTERS',
  UPDATE_NEW_FILTER: 'UPDATE_NEW_FILTER',
  RESET_TAB: 'RESET_TAB',
  RESET_SINGLE_TAB_FILTERS: 'RESET_SINGLE_TAB_FILTERS',
  SET_TAB_REFRESH: 'SET_TAB_REFRESH'
};
...
const SEARCH = {
  ...
  CLOSE: 'search/CLOSE',
  CLEAR: 'search/CLEAR',
  NAVIGATE_NEXT: 'search/NAVIGATE_NEXT',
  NAVIGATE_PREVIOUS: 'search/NAVIGATE_PREVIOUS',
  ...
  AUTO_NAVIGATION_DONE: 'search/AUTO_NAVIGATION_DONE',
  CLEAR_ACTIVE_SEARCH_HIGHLIGHT: 'search/CLEAR_ACTIVE_SEARCH_HIGHLIGHT',
  CHECK_DATA_PREREQUISITE: 'search/CHECK_DATA_PREREQUISITE',
  SET_CLEAR_INPUT_FLAG: 'search/SET_CLEAR_INPUT_FLAG',
  RESET_CLEAR_INPUT_FLAG: 'search/RESET_CLEAR_INPUT_FLAG',
  SHOW_MODAL: 'search/SHOW_MODAL',
  HIDE_MODAL: 'search/HIDE_MODAL'
};

const UI = {
  SHOW_SNACKBAR: 'ui/SHOW_SNACKBAR',
  HIDE_SNACKBAR: 'ui/HIDE_SNACKBAR',
  SET_SNACKBAR_MSG: 'ui/SET_SNACKBAR_MSG',
  SET_SNACKBAR_OPTIONS: 'ui/SET_SNACKBAR_OPTIONS',
  RESET_SNACKBAR: 'ui/RESET_SNACKBAR'
};
