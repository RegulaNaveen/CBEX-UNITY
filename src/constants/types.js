...
const PROPOSAL = {
  ...
  PROPOSAL_CUSTOM_TAB_SET_QUESTION: 'PROPOSAL_CUSTOM_TAB_SET_QUESTION',
...
const PROPOSALS = {
  ...
  FROM: 'FROM',
  SET_ALL_PROPOSALS: 'SET_ALL_PROPOSALS',
  SET_ERROR: 'SET_ERROR',
...
const APPROVALS = {
  ...
  SET_APPROVAL_QUESTION_APPROVALS_TAB: 'SET_APPROVAL_QUESTION_APPROVALS_TAB',
  UPDATE_APPROVAL_QUESTION_CUSTOM_TAB: 'UPDATE_APPROVAL_QUESTION_CUSTOM_TAB',
  UPDATE_NEW_FILTER: 'UPDATE_NEW_FILTER',
  DELETE_APPROVAL_QUESTION_CUSTOM_TAB: 'DELETE_APPROVAL_QUESTION_CUSTOM_TAB'
};
...
const UNITY_TABS = {
  ...
  SET_CUSTOM_QUESTION_CUSTOM_TAB: 'SET_CUSTOM_QUESTION_CUSTOM_TAB',
  DELETE_CUSTOM_QUESTION_CUSTOM_TAB: 'DELETE_CUSTOM_QUESTION_CUSTOM_TAB',
  UPDATE_CUSTOM_QUESTION_CUSTOM_TAB: 'UPDATE_CUSTOM_QUESTION_CUSTOM_TAB'
};
...
const EMAILTEMPLATES = {
  FECTH_EMAIL_TEMPLATES: 'FECTH_EMAIL_TEMPLATES',
  ERROR_FETCHING_EMAIL_TEMPLATES: 'ERROR_FETCHING_EMAIL_TEMPLATES',
  IS_LOADING_EMAIL_TEMPLATES: 'IS_LOADING_EMAIL_TEMPLATES'
};

const TASKS = {
  SET_TASKS: 'SET_TASKS',
  LOADING_TASKS: 'LOADING_TASKS',
  ERROR_FETCHING_TASKS: 'ERROR_FETCHING_TASKS',
  ADD_TASK: 'ADD_TASK',
  EDIT_TASK: 'EDIT_TASK',
  SET_TASK_HISTORY: 'SET_TASK_HISTORY',
  LOADING_TASK_HISTORY: 'LOADING_TASK_HISTORY',
  TOGGLE_SHOW_MINE: 'TOGGLE_SHOW_MINE',
  TOGGLE_CAN_REORDER: 'TOGGLE_CAN_REORDER'
};

const OPPORTUNITIES = {
  SET_OPPORTUNITIES: 'OPPORTUNITIES/SET_OPPORTUNITIES',
  SET_PAGE: 'OPPORTUNITIES/SET_PAGE',
  SET_ITEMS_PER_PAGE: 'OPPORTUNITIES/SET_ITEMS_PER_PAGE',
  SET_FILTERS: 'OPPORTUNITIES/SET_FILTERS',
  SET_LOADING: 'OPPORTUNITIES/SET_LOADING',
  SET_TOTAL: 'OPPORTUNITIES/SET_TOTAL'
};

const CHATBOT = {
  SET_CHATBOT_BUBBLES: 'SET_CHATBOT_BUBBLES',
  ADD_CHATBOT_BUBBLE: 'ADD_CHATBOT_BUBBLE',
  UPDATE_CHATBOT_BUBBLE: 'UPDATE_CHATBOT_BUBBLE',
  SET_CHATBOT_BUBBLES_LOADING: 'SET_CHATBOT_BUBBLES_LOADING',
  SET_CHATBOT_BUBBLES_ERROR: 'SET_CHATBOT_BUBBLES_ERROR',
  SET_CHATBOT_BUBBLES_RESET: 'SET_CHATBOT_BUBBLES_RESET',
  SET_CHATBOT_BUBBLES_CLEAR: 'SET_CHATBOT_BUBBLES_CLEAR',
  SET_LOADING_STATE: 'SET_LOADING_STATE',
  UPDATE_BUBBLE: 'UPDATE_BUBBLE',
  FETCHING_HISTORY: 'FETCHING_HISTORY',
  SET_MESSAGE_WATCHERS_MAP: 'CHATBOT/SET_MESSAGE_WATCHERS_MAP'
};
